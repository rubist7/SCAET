        ...
        <div className="w-full max-w-[330px] sm:max-w-sm md:max-w-md flex flex-col items-center gap-3 sm:gap-4">
          <div className="flex flex-col items-center gap-0">
            ...
            <div className="text-center">
              <h1 className={`text-lg sm:text-3xl font-logo tracking-widest -mt-6 ${isDark ? 'text-violet-300 drop-shadow-[0_0_10px_rgba(167,139,250,0.65)]' : 'text-violet-500'}`}>
                SCAET
              </h1>
          ...
          <form noValidate onSubmit={handleRegister} className={`w-full flex flex-col gap-2.5 sm:gap-3 rounded-2xl border px-4 py-4 sm:px-6 sm:py-5 ${isDark ? 'border-violet-300/10 bg-[#15101f] shadow-[0_18px_50px_rgba(0,0,0,0.35)]' : 'border-transparent bg-white shadow-lg'}`}>
